...
public class TimeTableTest {
	 ...
	 @Test
	  public void test01()  throws Throwable  { //testing everything normally woithout exceptions
	 ...
	 @Test
	  public void test02()  throws Throwable  { //testing the private function getNextApptOcurrence
...
LinkedList<Appt> appts= new LinkedList<Appt>();	 
		 ...
		 Appt appt1 = new Appt(startHour,
		          ...
		          title,
		         description);
		 appt1.setRecurrence(array2, appt1.RECUR_BY_WEEKLY, 2, appt1.RECUR_NUMBER_FOREVER);
		 appts.add(appt1);
		...
		// appt1.setRecurrence(array2, appt1.RECUR_BY_WEEKLY, 2, appt1.RECUR_NUMBER_FOREVER); //length 0 array
		
	 }
	 
	 @Test
	  public void test03()  throws Throwable  { // tests if timetable works when adding 3 appts
 ...
 LinkedList<Appt> appts= new LinkedList<Appt>();	 
		 ...
		 LinkedList<Appt> appts2= new LinkedList<Appt>(); //quickly testing for null exceptions
		 appts2 = null;
